...
void NvptxCompiler::Compile(std::unique_ptr<llvm::Module>& llvm_module, ScheduleMap& schedule_map) {
...
std::string NvptxCompiler::ConverToPtx(std::unique_ptr<llvm::Module>& llvm_module) {
